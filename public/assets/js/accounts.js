...
$("#add-account").on("click", function (event) {
  ...
  if (newAccount.email.length > 0 && newAccount.account_key.length > 0 && newAccount.last_name.length > 0 && newAccount.first_name.length > 0) {
    $.ajax({
      type: "post",
      url: "/signup",
      data: newAccount
...
$("#update-account").on("click", function (event) {
  ...
  if ( changeAccount.account_key.length > 0 && changeAccount.account_key.length > 0 && changeAccount.last_name.length > 0 && changeAccount.first_name.length > 0){
    $.ajax({
      type: "PUT",
